...
content_id: 25c28ecf61a54f206e34da33a57aa73da3a33a2757aaf4d4a3a9e50be95704c8
---
...
spotifyService.searchAlbums("need you now lady a").then(found_albums => {
  ...
  console.log("URI:", found_albums.albums.items[0].uri);
})
